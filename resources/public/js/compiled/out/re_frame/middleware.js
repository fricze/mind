...
if(!((function (){var G__25705 = app_db;
if(G__25705){
...
return G__25705.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__25705.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__25705);
} else {
return false;
}
}
...
while (G__25710__i < G__25710__a.length) {G__25710__a[G__25710__i] = arguments[G__25710__i + 0]; ++G__25710__i;}
  args = new cljs.core.IndexedSeq(G__25710__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25711){
var args = cljs.core.seq(arglist__25711);
...
return cljs.core.get_in.call(null,new_db,p1__25712_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25713_SHARP_){
return cljs.core.get_in.call(null,db,p1__25713_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__25714__i < G__25714__a.length) {G__25714__a[G__25714__i] = arguments[G__25714__i + 2]; ++G__25714__i;}
  in_paths = new cljs.core.IndexedSeq(G__25714__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25715){
var f = cljs.core.first(arglist__25715);
arglist__25715 = cljs.core.next(arglist__25715);
var out_path = cljs.core.first(arglist__25715);
var in_paths = cljs.core.rest(arglist__25715);
...
//# sourceMappingURL=middleware.js.map?rel=1442499278896