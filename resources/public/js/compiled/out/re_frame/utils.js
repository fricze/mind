...
re_frame.utils.default_loggers = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"log","log",-1595516004),(function (p1__25824_SHARP_){
return console.log(p1__25824_SHARP_);
}),new cljs.core.Keyword(null,"warn","warn",-436710552),(function (p1__25825_SHARP_){
return console.warn(p1__25825_SHARP_);
}),new cljs.core.Keyword(null,"error","error",-978969032),(function (p1__25826_SHARP_){
return console.error(p1__25826_SHARP_);
}),new cljs.core.Keyword(null,"group","group",582596132),(function (p1__25827_SHARP_){
if(cljs.core.truth_(console.group())){
return console.group(p1__25827_SHARP_);
} else {
return console.log(p1__25827_SHARP_);
}
...
re_frame.utils.log.cljs$lang$applyTo = (function (seq25828){
return re_frame.utils.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25828));
});
...
re_frame.utils.warn.cljs$lang$applyTo = (function (seq25829){
return re_frame.utils.warn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25829));
});
...
re_frame.utils.group.cljs$lang$applyTo = (function (seq25830){
return re_frame.utils.group.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25830));
});
...
re_frame.utils.groupEnd.cljs$lang$applyTo = (function (seq25831){
return re_frame.utils.groupEnd.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25831));
});
...
re_frame.utils.error.cljs$lang$applyTo = (function (seq25832){
return re_frame.utils.error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25832));
});
...
//# sourceMappingURL=utils.js.map?rel=1442499279208