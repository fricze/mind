 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__31690){
var vec__31692 = p__31690;
var tag = cljs.core.nth.call(null,vec__31692,(0),null);
var re = cljs.core.nth.call(null,vec__31692,(1),null);
return ((function (vec__31692,tag,re){
return (function (s){
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__19200__auto__);
});
...
return p1__31693_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq31694){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31694));
});
/**
...
var map__31697 = temp__4124__auto__;
...
var size = cljs.core.get.call(null,map__31697__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var chunk = cljs.core.get.call(null,map__31697__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var tag = cljs.core.get.call(null,map__31697__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var G__31699 = cljs.core.subs.call(null,s1,size);
var G__31700 = [cljs.core.str(s2),cljs.core.str((function (){var G__31698 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__31698) {
case "l-brace":
return "}";
...
//# sourceMappingURL=compression.js.map?rel=1442499397783