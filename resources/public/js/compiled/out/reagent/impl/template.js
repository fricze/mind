...
var G__25398 = o;
(G__25398[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__25400__i < G__25400__a.length) {G__25400__a[G__25400__i] = arguments[G__25400__i + 0]; ++G__25400__i;}
  args = new cljs.core.IndexedSeq(G__25400__a,0);
} 
...
var args = cljs.core.seq(arglist__25401);
...
var old_25402 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25402))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25402)].join(''):class$));
} else {
}
...
var G__25405 = jsprops;
(G__25405["defaultValue"] = value);

(G__25405["onChange"] = ((function (G__25405,v,value,on_change){
return (function (p1__25403_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25403_SHARP_);
});})(G__25405,v,value,on_change))
);
...
var vec__25407 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25407,(0),null);
var id = cljs.core.nth.call(null,vec__25407,(1),null);
var class$ = cljs.core.nth.call(null,vec__25407,(2),null);
...
var temp__4128__auto__ = (function (){var G__25409 = cljs.core.meta.call(null,v);
var G__25409__$1 = (((G__25409 == null))?null:reagent.impl.template.get_key.call(null,G__25409));
return G__25409__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25411_25412 = v;
var G__25411_25413__$1 = (((G__25411_25412 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25411_25412));
var G__25411_25414__$2 = (((G__25411_25413__$1 == null))?null:(jsprops["key"] = G__25411_25413__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__25417 = cljs.core.meta.call(null,argv);
var G__25417__$1 = (((G__25417 == null))?null:reagent.impl.template.get_key.call(null,G__25417));
return G__25417__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__25418 = (((jsprops == null))?{}:jsprops);
(G__25418["key"] = key);
...
var n__19045__auto___25419 = a.length;
var i_25420 = (0);
while(true){
if((i_25420 < n__19045__auto___25419)){
(a[i_25420] = reagent.impl.template.as_element.call(null,(a[i_25420])));

var G__25421 = (i_25420 + (1));
i_25420 = G__25421;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19045__auto___25422 = a.length;
var i_25423 = (0);
while(true){
if((i_25423 < n__19045__auto___25422)){
var val_25424 = (a[i_25423]);
if((cljs.core.vector_QMARK_.call(null,val_25424)) && ((reagent.impl.template.key_from_vec.call(null,val_25424) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25423] = reagent.impl.template.as_element.call(null,val_25424));

var G__25425 = (i_25423 + (1));
i_25423 = G__25425;
continue;
} else {
}
...
var G__25427 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25427) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25427){
...
//# sourceMappingURL=template.js.map?rel=1442499278224